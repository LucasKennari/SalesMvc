...
namespace SalesWebMvc.Data
{
	public class SeedingService
	{
		...
		public void Seed()
		{
			...
			//_context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[Department] ON");
			...
			//_context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[Department] OFF");

			//_context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[Seller] ON");
			...
			Seller s6 = new(6, "Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 3000.0, d4);

			//_context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[Seller] OFF");



			//_context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[SalesRecord] ON");
			...
			//_context.Database.ExecuteSqlRaw("SET IDENTITY_INSERT [dbo].[SalesRecord] OFF");
